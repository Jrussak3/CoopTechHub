import miastaSuwerennosciCover from '../../assets/covers/miasta-dla-suwerennosci.png';
import hybrydoweTargowiskaCover from '../../assets/covers/hybrydowe-targowiska.png';
import miejskaEnergetykaCover from '../../assets/covers/miejska-energetyka-obywatelska.png';
import krakowskaEnergetykaCover from '../../assets/covers/krakowska-energetyka-obywatelska.png';
import pracaKtorejNieZabierzeCiAiCover from '../../assets/covers/praca-ktorej-nie-zabierze-ci-ai.jpg';
import zwiazekSercCover from '../../assets/covers/zwiazek-serc.png';

export type PublicationTag = 'cyfryzacja' | 'energetyka' | 'rozwoj-lokalny';
...
export const publicationTagLabels: Record<PublicationTag, string> = {
...
const rawPublications: PublicationItem[] = [
  {
    ...
    date: '17.06.2026',
    tag: 'rozwoj-lokalny',
    thumbnailUrl: pracaKtorejNieZabierzeCiAiCover,
    attachment: {
  ...
  },
  {
    ...
    date: '04.06.2025',
    tag: 'rozwoj-lokalny',
    thumbnailUrl: miastaSuwerennosciCover,
    attachment: {
      label: 'Pobierz raport (PDF)',
  ...
  },
  {
    ...
    date: '03.09.2024',
    tag: 'rozwoj-lokalny',
    thumbnailUrl: hybrydoweTargowiskaCover,
    attachment: {
      label: 'Pobierz raport (PDF)',
  ...
  },
  {
    ...
    date: '03.04.2024',
    tag: 'energetyka',
    thumbnailUrl: miejskaEnergetykaCover,
    attachment: {
      label: 'Pobierz raport (PDF)',
  ...
  },
  {
    ...
    date: '27.09.2023',
    tag: 'energetyka',
    thumbnailUrl: krakowskaEnergetykaCover,
    attachment: {
      label: 'Pobierz raport (PDF)',
...
export const publications: PublicationItem[] = [...rawPublications].sort(
  (a, b) => parseDate(b.date) - parseDate(a.date),
);

export function getFeaturedPublications(limit = 3): PublicationItem[] {
  return publications.slice(0, limit);
}

export function getHighlightedPublications(offset = 3, limit = 2): PublicationItem[] {
  return publications.slice(offset, offset + limit);
}

export function getFirstPublicationByTag(tag: PublicationTag): PublicationItem | undefined {
  return publications.find((publication) => publication.tag === tag);
}

export function getPublicationsByTag(tag: PublicationTag, limit = 3): PublicationItem[] {
