...
const teamMembers = [
  {
    ...
    photo: '/assets/team_photos/jan_oleszczuk_zygmuntowski.png',
  ...
  {
    name: 'Joanna Erbel',
    photo: '/assets/team_photos/joanna_erbel.png',
  ...
  {
    name: 'Tomasz Janas',
    photo: '/assets/team_photos/tomasz_janas.png',
  ...
  },
  {
    ...
    photo: '/assets/team_photos/nadia_oleszczuk_zygmuntowska.png',
  ...
  },
  {
    ...
    photo: '/assets/team_photos/joanna_gosiewska_giralt.png',
    ...
    photo: '/assets/team_photos/michał_pietrusiewicz.png',
    bio: 'Współtwórca ekosystemu PLZ. Architekt systemów i rozwiązań IT z 25-letnim doświadczeniem. Tworzył systemy cyfrowe (web i mobile) dla instytucji finansowych na całym świecie. Projektuje innowacyjne rozwiązania oraz wdraża transformację cyfrową w bankach oraz największych zakładach produkcyjnych w Europie.',
    socials: [],
  },
    {
    name: 'Magda Agata Domańska',
    photo: '/assets/team_photos/magda_agata_domańska.png',
    bio: '',
    socials: [],
  },
  {
    name: 'Jakub Russak',
    photo: '/assets/team_photos/jakub_russak.png',
    bio: '',
    socials: [],
  },
  {
    name: 'Mateusz Różański',
    photo: '/assets/team_photos/mateusz_różański.png',
    bio: '',
    socials: [],
  },
  {
    name: 'Rafał Prus',
    photo: '/assets/team_photos/rafał_prus.png',
    bio: '',
    socials: [],
  },
];
    ...
    .map(
      (member) => `
        <article class="team-card">
          ...
          <h3>${member.name}</h3>
          <p class="${member.bio ? '' : 'team-card-bio-placeholder'}">${member.bio || ''}</p>
          ${
